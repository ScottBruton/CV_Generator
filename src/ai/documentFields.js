...
export function flattenEditableFields(cover = {}, cv = {}) {
  const fields = [];
...
function setAtPath(root, fieldPath, value) {
  ...
  for (let i = 0; i < parts.length - 1; i += 1) {
    ...
    // Convert string bullet to object when writing .text
...
export function applyFieldUpdates(docs, updates = []) {
...
export function getFieldText(docs, fieldPath) {
...
export function createClientSnapshot(cover, cv) {
